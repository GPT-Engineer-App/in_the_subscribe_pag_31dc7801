  ...
  return (
    <Flex as="header" width="full" align="center" justify="space-between" p={4} borderBottomWidth="1px">
      ...
      <HStack spacing={4} display={{ base: "none", md: "flex" }}>
        ...
        <IconButton aria-label="Open menu" fontSize="20px" display={{ base: "block", md: "none" }} icon={<FaBars />} onClick={() => setIsMenuOpen(!isMenuOpen)} />
        <Box pb={4} display={{ base: isMenuOpen ? "block" : "none", md: "none" }}>
          <Navigation />
        </Box>
